...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.suco-card, .feature, .stat, .contato-item');
...
${mensagemSelecionada}`;
    ...
    const cards = document.querySelectorAll('.suco-card, .cafe-type, .contato-item');
    cards.forEach(card => {
